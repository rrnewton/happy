...
export const es: TranslationStructure = {
    ...
    settings: {
        ...
        webNotifications: {
            ...
            subtitle: 'Recibe notificaciones cuando las sesiones estén listas para entrada',
            permissionDenied: 'Permiso denegado',
            permissionInstructions: 'Habilita las notificaciones en la configuración de tu navegador para usar esta función.',
            testNotification: 'Notificación de prueba',
            testNotificationSubtitle: 'Enviar una notificación de prueba para ver cómo aparecen',
        },
        ...
        codingStats: 'Estadísticas de programación',
        codingStatsSubtitle: 'Ver tu actividad de programación de Wakapi',
        wakapi: 'Configuración de Wakapi',
        wakapiSubtitle: 'Configurar integración con Wakapi',
    ...
    settingsFeatures: {
        ...
        autoCopyOnSelection: 'Copia automática al seleccionar',
        autoCopyOnSelectionSubtitle: 'Copiar automáticamente el texto seleccionado al portapapeles',
    },
    ...
    sessionInfo: {
        ...
        deleteActiveSessionWarning: 'La sesión activa se archivará primero y luego se eliminará permanentemente. Esta acción no se puede deshacer.',
        ...
        customizeTitleSubtitle: 'Establecer un nombre personalizado para esta sesión',
        enterCustomTitle: 'Introducir título personalizado',
        enterTitlePlaceholder: 'Introduce un título para esta sesión',
        titleUpdated: 'Título actualizado correctamente',
        removeCustomTitle: 'Eliminar título personalizado',
        removeCustomTitleSubtitle: 'Restablecer al título predeterminado',
    ...
    settingsVoice: {
        ...
        customApiUrlHint: 'Reemplaza el endpoint predeterminado de OpenAI con tu propia URL de API compatible con Whisper. Deja vacío para usar OpenAI.',
        customModel: 'Modelo personalizado',
        customModelPlaceholder: 'whisper-1',
        customModelHint: 'Especifica qué modelo de Whisper utilizar. Opciones comunes: whisper-1 (predeterminado), whisper-large-v3 u otros modelos compatibles. Deja vacío para usar el predeterminado.',
    ...
    settingsWakapi: {
        status: 'Estado',
        statusDescription: 'Rastrea tu actividad de programación con Wakapi o WakaTime',
        codingStats: 'Estadísticas de programación',
        notConfigured: 'No configurado',
        configured: 'Configurado',
        connectedAs: ({ username }: { username: string }) => `Conectado como ${username}`,
        setupPrompt: 'Conecta Wakapi para ver tus estadísticas de programación',
        configure: 'Configurar',
        apiConfiguration: 'Configuración de API',
        apiConfigurationDescription: 'Ingresa tus credenciales de API de Wakapi o WakaTime',
        apiUrl: 'URL de API',
        whatIsWakapi: '¿Qué es Wakapi?',
        apiKey: 'Clave API',
        apiKeyPlaceholder: 'Tu clave API',
        apiKeyHint: 'Encuentra tu clave API en la configuración de Wakapi en API > Clave API',
        corsProxy: 'Proxy CORS',
        corsProxyDescription: 'Requerido para que el navegador web acceda a la API de Wakapi. Despliega el worker del proxy e ingresa su URL aquí.',
        useProxy: 'Usar proxy CORS',
        useProxySubtitle: 'Habilitar proxy para acceso del navegador web',
        proxyUrl: 'URL del proxy',
        testConnection: 'Probar conexión',
        save: 'Guardar',
        connectionSuccess: ({ username }: { username: string }) => `Conectado exitosamente como ${username}`,
        apiUrlAndKeyRequired: 'Se requieren URL de API y clave API',
        configureFirst: 'Por favor, configura primero la URL de API y la clave API',
        settingsSaved: 'Configuración de Wakapi guardada',
