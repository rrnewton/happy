...
export const pl: TranslationStructure = {
    ...
    settings: {
        ...
        // Web notifications
        webNotifications: {
            title: 'Powiadomienia na pulpicie',
            subtitle: 'Otrzymuj powiadomienia, gdy sesje są gotowe do wprowadzania danych',
            permissionDenied: 'Odmowa uprawnień',
            permissionInstructions: 'Włącz powiadomienia w ustawieniach przeglądarki, aby korzystać z tej funkcji.',
            testNotification: 'Powiadomienie testowe',
            testNotificationSubtitle: 'Wyślij testowe powiadomienie, aby zobaczyć, jak wyglądają',
        },
        ...
        codingStatsSubtitle: 'Zobacz swoją aktywność kodowania z Wakapi',
        wakapi: 'Ustawienia Wakapi',
        wakapiSubtitle: 'Skonfiguruj integrację z Wakapi',
    ...
    sessionInfo: {
        ...
        forkSessionSubtitle: 'Rozpocznij nową sesję rozgałęziając tę rozmowę',
        deleteSession: 'Usuń',
    ...
    settingsVoice: {
        ...
        customApiUrl: 'Własny URL API',
        optional: 'Opcjonalnie',
        customApiUrlPlaceholder: 'https://your-api.example.com/v1/audio/transcriptions',
        customApiUrlHint: 'Zastąp domyślny endpoint OpenAI swoim własnym adresem URL API kompatybilnego z Whisper. Pozostaw puste, aby używać OpenAI.',
        customModel: 'Własny model',
        customModelPlaceholder: 'whisper-1',
        customModelHint: 'Określ, którego modelu Whisper użyć. Popularne opcje: whisper-1 (domyślny), whisper-large-v3 lub inne kompatybilne modele. Pozostaw puste, aby użyć domyślnego.',
    ...
    keyboardShortcuts: {
        ...
        forkSession: 'Rozgałęź / Kontynuuj sesję',
        archiveSession: 'Zarchiwizuj',
    ...
    settingsWakapi: {
        status: 'Status',
        statusDescription: 'Śledź swoją aktywność kodowania za pomocą Wakapi lub WakaTime',
        codingStats: 'Statystyki kodowania',
        notConfigured: 'Nieskonfigurowane',
        configured: 'Skonfigurowane',
        connectedAs: ({ username }: { username: string }) => `Połączono jako ${username}`,
        setupPrompt: 'Połącz Wakapi, aby zobaczyć swoje statystyki kodowania',
        configure: 'Konfiguruj',
        apiConfiguration: 'Konfiguracja API',
        apiConfigurationDescription: 'Wprowadź swoje dane uwierzytelniające API Wakapi lub WakaTime',
        apiUrl: 'URL API',
        whatIsWakapi: 'Co to jest Wakapi?',
        apiKey: 'Klucz API',
        apiKeyPlaceholder: 'Twój klucz API',
        apiKeyHint: 'Znajdź swój klucz API w ustawieniach Wakapi w sekcji API > Klucz API',
        corsProxy: 'Proxy CORS',
        corsProxyDescription: 'Wymagane do dostępu przeglądarki internetowej do API Wakapi. Wdróż workera proxy i wprowadź jego URL tutaj.',
        useProxy: 'Użyj proxy CORS',
        useProxySubtitle: 'Włącz proxy dla dostępu przeglądarki internetowej',
        proxyUrl: 'URL proxy',
        testConnection: 'Testuj połączenie',
        save: 'Zapisz',
        connectionSuccess: ({ username }: { username: string }) => `Pomyślnie połączono jako ${username}`,
        apiUrlAndKeyRequired: 'Wymagane są URL API i klucz API',
        configureFirst: 'Najpierw skonfiguruj URL API i klucz API',
        settingsSaved: 'Ustawienia Wakapi zapisane',
