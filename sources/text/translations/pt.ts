...
export const pt: TranslationStructure = {
    ...
    settings: {
        ...
        codingStats: 'Estatísticas de programação',
        codingStatsSubtitle: 'Ver sua atividade de programação do Wakapi',
        wakapi: 'Configurações do Wakapi',
        wakapiSubtitle: 'Configurar integração com Wakapi',
    ...
    settingsAppearance: {
        ...
        bootSequence: 'Sequencia de inicializacao',
        bootSequenceDescription: 'Mostrar animacao estilo BIOS retro ao iniciar o aplicativo',
    },
    ...
    session: {
        ...
        loadingHistory: 'Carregando histórico da conversa...',
        historyLoadedAll: 'Todas as mensagens carregadas',
        historyError: 'Não foi possível carregar mensagens anteriores',
    },
    ...
    sessionInfo: {
        ...
        forkSessionSubtitle: 'Iniciar uma nova sessão ramificando esta conversa',
    ...
    settingsVoice: {
        ...
        customApiUrlHint: 'Substitua o endpoint padrão da OpenAI pelo URL da sua API personalizada compatível com Whisper. Deixe vazio para usar a OpenAI.',
        customModel: 'Modelo personalizado',
        customModelPlaceholder: 'whisper-1',
        customModelHint: 'Especifique qual modelo Whisper usar. Opções comuns: whisper-1 (padrão), whisper-large-v3 ou outros modelos compatíveis. Deixe vazio para usar o padrão.',
    ...
    settingsWakapi: {
        status: 'Status',
        statusDescription: 'Acompanhe sua atividade de programação com Wakapi ou WakaTime',
        codingStats: 'Estatísticas de programação',
        notConfigured: 'Não configurado',
        configured: 'Configurado',
        connectedAs: ({ username }: { username: string }) => `Conectado como ${username}`,
        setupPrompt: 'Conecte o Wakapi para ver suas estatísticas de programação',
        configure: 'Configurar',
        apiConfiguration: 'Configuração da API',
        apiConfigurationDescription: 'Insira suas credenciais da API do Wakapi ou WakaTime',
        apiUrl: 'URL da API',
        whatIsWakapi: 'O que é Wakapi?',
        apiKey: 'Chave API',
        apiKeyPlaceholder: 'Sua chave API',
        apiKeyHint: 'Encontre sua chave API nas configurações do Wakapi em API > Chave API',
        corsProxy: 'Proxy CORS',
        corsProxyDescription: 'Necessário para o navegador web acessar a API do Wakapi. Implante o worker do proxy e insira sua URL aqui.',
        useProxy: 'Usar proxy CORS',
        useProxySubtitle: 'Habilitar proxy para acesso do navegador web',
        proxyUrl: 'URL do proxy',
        testConnection: 'Testar conexão',
        save: 'Salvar',
        connectionSuccess: ({ username }: { username: string }) => `Conectado com sucesso como ${username}`,
        apiUrlAndKeyRequired: 'URL da API e chave API são obrigatórios',
        configureFirst: 'Por favor, configure primeiro a URL da API e a chave API',
        settingsSaved: 'Configurações do Wakapi salvas',
