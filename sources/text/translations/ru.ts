...
export const ru: TranslationStructure = {
    ...
    settings: {
        ...
        codingStats: 'Статистика кодинга',
        codingStatsSubtitle: 'Просмотр активности кодинга из Wakapi',
        wakapi: 'Настройки Wakapi',
        wakapiSubtitle: 'Настройка интеграции с Wakapi',
    ...
    status: {
        ...
        interactionRequired: 'требуется взаимодействие',
    ...
    settingsVoice: {
        ...
        customApiUrl: 'Свой URL API',
        optional: 'Необязательно',
        customApiUrlPlaceholder: 'https://your-api.example.com/v1/audio/transcriptions',
        customApiUrlHint: 'Укажите свой URL API вместо стандартного адреса OpenAI для использования совместимого с Whisper сервиса. Оставьте пустым для использования OpenAI.',
        customModel: 'Пользовательская модель',
        customModelPlaceholder: 'whisper-1',
        customModelHint: 'Укажите, какую модель Whisper использовать. Популярные варианты: whisper-1 (по умолчанию), whisper-large-v3 или другие совместимые модели. Оставьте пустым для использования модели по умолчанию.',
    ...
    settingsWakapi: {
        status: 'Статус',
        statusDescription: 'Отслеживайте свою активность кодинга с помощью Wakapi или WakaTime',
        codingStats: 'Статистика кодинга',
        notConfigured: 'Не настроено',
        configured: 'Настроено',
        connectedAs: ({ username }: { username: string }) => `Подключено как ${username}`,
        setupPrompt: 'Подключите Wakapi, чтобы увидеть статистику кодинга',
        configure: 'Настроить',
        apiConfiguration: 'Настройка API',
        apiConfigurationDescription: 'Введите ваши учётные данные API Wakapi или WakaTime',
        apiUrl: 'URL API',
        whatIsWakapi: 'Что такое Wakapi?',
        apiKey: 'Ключ API',
        apiKeyPlaceholder: 'Ваш ключ API',
        apiKeyHint: 'Найдите ваш ключ API в настройках Wakapi в разделе API > Ключ API',
        corsProxy: 'CORS прокси',
        corsProxyDescription: 'Требуется для доступа к API Wakapi из веб-браузера. Разверните прокси-воркер и введите его URL здесь.',
        useProxy: 'Использовать CORS прокси',
        useProxySubtitle: 'Включить прокси для доступа из веб-браузера',
        proxyUrl: 'URL прокси',
        testConnection: 'Проверить соединение',
        save: 'Сохранить',
        connectionSuccess: ({ username }: { username: string }) => `Успешно подключено как ${username}`,
        apiUrlAndKeyRequired: 'Требуются URL API и ключ API',
        configureFirst: 'Сначала настройте URL API и ключ API',
        settingsSaved: 'Настройки Wakapi сохранены',
