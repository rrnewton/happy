...
export const ca: TranslationStructure = {
    ...
    status: {
        ...
        interactionRequired: 'interacció requerida',
        activeNow: 'Actiu ara',
        unknown: 'desconegut',
    },
    ...
    settings: {
        ...
        codingStats: 'Estadístiques de programació',
        codingStatsSubtitle: 'Veure la teva activitat de programació de Wakapi',
        wakapi: 'Configuració de Wakapi',
        wakapiSubtitle: 'Configura la integració amb Wakapi',
    ...
    settingsFeatures: {
        ...
        autoCopyOnSelection: 'Còpia automàtica en seleccionar',
        autoCopyOnSelectionSubtitle: 'Copia automàticament el text seleccionat al porta-retalls',
    },
    ...
    newSession: {
        ...
        sessionType: {
            ...
            worktreeNamePlaceholder: 'Nom de la branca (p. ex. feature-login)',
        },
        worktree: {
    ...
    settingsVoice: {
        ...
        customApiUrl: 'URL d\'API personalitzada',
        optional: 'Opcional',
        customApiUrlPlaceholder: 'https://your-api.example.com/v1/audio/transcriptions',
        customApiUrlHint: 'Substitueix l\'endpoint predeterminat d\'OpenAI amb la teva URL d\'API personalitzada compatible amb Whisper. Deixa buit per utilitzar OpenAI.',
        customModel: 'Model personalitzat',
        customModelPlaceholder: 'whisper-1',
        customModelHint: 'Especifica quin model de Whisper utilitzar. Opcions comunes: whisper-1 (predeterminat), whisper-large-v3 o altres models compatibles. Deixa buit per utilitzar el predeterminat.',
    ...
    settingsWakapi: {
        status: 'Estat',
        statusDescription: 'Fes un seguiment de la teva activitat de programació amb Wakapi o WakaTime',
        codingStats: 'Estadístiques de programació',
        notConfigured: 'No configurat',
        configured: 'Configurat',
        connectedAs: ({ username }: { username: string }) => `Connectat com a ${username}`,
        setupPrompt: 'Connecta Wakapi per veure les teves estadístiques de programació',
        configure: 'Configurar',
        apiConfiguration: 'Configuració de l\'API',
        apiConfigurationDescription: 'Introdueix les teves credencials de l\'API de Wakapi o WakaTime',
        apiUrl: 'URL de l\'API',
        whatIsWakapi: 'Què és Wakapi?',
        apiKey: 'Clau API',
        apiKeyPlaceholder: 'La teva clau API',
        apiKeyHint: 'Troba la teva clau API a la configuració de Wakapi sota API > Clau API',
        corsProxy: 'Proxy CORS',
        corsProxyDescription: 'Requerit perquè el navegador web accedeixi a l\'API de Wakapi. Desplega el worker del proxy i introdueix la seva URL aquí.',
        useProxy: 'Usa proxy CORS',
        useProxySubtitle: 'Activa el proxy per a l\'accés del navegador web',
        proxyUrl: 'URL del proxy',
        testConnection: 'Provar connexió',
        save: 'Desar',
        connectionSuccess: ({ username }: { username: string }) => `Connectat correctament com a ${username}`,
        apiUrlAndKeyRequired: 'Es requereixen l\'URL de l\'API i la clau API',
        configureFirst: 'Si us plau, configura primer l\'URL de l\'API i la clau API',
        settingsSaved: 'Configuració de Wakapi desada',
        totalTime: 'Temps total',
        dailyAverage: 'Mitjana diària',
        projects: 'Projectes',
