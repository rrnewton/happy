...
export const en = {
    ...
    settings: {
        ...
        codingStatsSubtitle: 'View your coding activity from Wakapi',
        wakapi: 'Wakapi Settings',
        wakapiSubtitle: 'Configure Wakapi integration',
    ...
    newSession: {
        ...
        resumeSessionPlaceholder: 'Resume from session ID (Claude or Codex, optional)',
        sessionType: {
            title: 'Session Type',
            simple: 'Simple',
            worktree: 'Worktree',
    ...
    settingsEnvironments: {
        ...
        helpText: 'Tap the star to apply by default. Multiple sets can be marked as default. Tap an environment set to edit or delete it.',
        tipText: 'Environment sets are applied when starting new sessions. Multiple sets can be selected and merged (later sets override earlier). Variables like ANTHROPIC_BASE_URL and ANTHROPIC_AUTH_TOKEN can be used to connect to different API providers.',
    },
    ...
    settingsWakapi: {
        // Wakapi settings screen
        status: 'Status',
        statusDescription: 'Track your coding activity with Wakapi or WakaTime',
        codingStats: 'Coding Stats',
        notConfigured: 'Not configured',
        configured: 'Configured',
        connectedAs: ({ username }: { username: string }) => `Connected as ${username}`,
        setupPrompt: 'Connect Wakapi to see your coding statistics',
        configure: 'Configure',
        apiConfiguration: 'API Configuration',
        apiConfigurationDescription: 'Enter your Wakapi or WakaTime API credentials',
        apiUrl: 'API URL',
        whatIsWakapi: 'What is Wakapi?',
        apiKey: 'API Key',
        apiKeyPlaceholder: 'Your API key',
        apiKeyHint: 'Find your API key in Wakapi settings under API > API Key',
        corsProxy: 'CORS Proxy',
        corsProxyDescription: 'Required for web browser to access Wakapi API. Deploy the proxy worker and enter its URL here.',
        useProxy: 'Use CORS Proxy',
        useProxySubtitle: 'Enable proxy for web browser access',
        proxyUrl: 'Proxy URL',
        testConnection: 'Test Connection',
        save: 'Save',
        connectionSuccess: ({ username }: { username: string }) => `Connected successfully as ${username}`,
        apiUrlAndKeyRequired: 'API URL and API key are required',
        configureFirst: 'Please configure API URL and API key first',
        settingsSaved: 'Wakapi settings saved',
