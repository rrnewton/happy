 ...
 * Shows notifications when sessions become ready for input (triggered by CLI ready events)
 */
export class WebNotificationManager {
     ...
     * Called when a ready event is received from the CLI
     */
    showSessionReady(sessionId: string, sessionName?: string) {
